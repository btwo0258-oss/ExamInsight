...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/learning/:id/study', name: 'learning-study', component: () => import('@/views/student/LearningStudyView.vue'), props: true },
    { path: '/learning/:id/practice', name: 'learning-practice', component: () => import('@/views/student/LearningPracticeView.vue'), props: true },
    { path: '/learning/:id/mistakes', name: 'learning-mistakes', component: () => import('@/views/student/LearningMistakesView.vue'), props: true },
    ...
    { path: '/library/:id', name: 'library-detail', component: () => import('@/views/student/LibraryDetailView.vue'), props: true },
