...
.mistake-layout > aside button + button::before { position: absolute; top: -1px; right: 9px; left: 9px; height: 1px; background: var(--color-border); content: ''; }
.mistake-layout > aside button { width: calc(100% - 2px); margin-inline: 1px; gap: 8px; padding: 10px 8px; border-radius: 9px; }
</style>
